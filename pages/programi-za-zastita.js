...
const PortfolioGridIsotope5 = dynamic(
  () => import("../src/components/PortfolioGridIsotope5"),
  {
    ssr: false,
  }
);
...
const Portfolio = () => {
  ...
  return (
    <Layout>
      <PageBanner pageTitle={"Програми За Заштита"} pageName="Програми За Заштита" />
      <section
