...
const Farmers = () => {
  return (
    <Layout>
      <PageBanner pageName={"Органски Ѓубрива"} />
          ...
          <div className="row">
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInDown">
                ...
                <div className="member-info">
                  ...
                  <p className="position">Органски Ѓубрива</p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">HUMI MAX</Link>
                  </h3>
                  <p className="position">Органски Ѓубрива</p>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInDown">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">HUMIC TOTAL</Link>
                  </h3>
                  <p className="position">Органски Ѓубрива</p>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">MICRO RICH</Link>
                  </h3>
                  <p className="position">Органски Ѓубрива</p>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">ROOTMOST</Link>
                  </h3>
                  <p className="position">Органски Ѓубрива</p>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">SEAMINO</Link>
                  </h3>
                  <p className="position">Органски Ѓубрива</p>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">SOFT GUARD</Link>
                  </h3>
                  <p className="position">Органски Ѓубрива</p>
                </div>
              </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">SPRЕАDER</Link>
                  </h3>
                  <p className="position">Органски Ѓубрива</p>
                </div>
              </div>
