...
const Farmers = () => {
  return (
    <Layout>
      <PageBanner pageName={"Кристални Ѓубрива"} />
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/portfolio-details">
                      <a>TERA NOVA (NPK 16:8:24+TE)</a>
                    </Link>
                  </h3>
                  <p className="position">Кристални Ѓубрива</p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
