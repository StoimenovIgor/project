...
const PortfolioGridIsotope3 = dynamic(
  () => import ("../src/components/PortfolioGridIsotope3"),
  {
    ssr: false,
  }
);
...
const Portfolio = () => {
  ...
  return (
    ...
    <Layout>
      <PageBanner pageTitle={"Ѓубриво"} pageName="ѓубриво" />
      <section
            ...
            <div className="col-xl-7 col-lg-10">
              <div className="section-title text-center mb-50 wow fadeInUp">
                ...
                <h2 className="sub-title">
                 {t('typeOfFeritilizers')}
                </h2>
              </div>
            </div>
          </div>
          <PortfolioGridIsotope3/>
          <div className="row">
