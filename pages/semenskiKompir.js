          ...
          <div className="row">
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInDown">
                ...
                <div className="member-info">
                  ...
                  <p className="position">Семенски Компир</p>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInDown">
                ...
                <div className="member-info">
                  ...
                  <p className="position">Семенски Компир</p>
                  <p className="position">Ран Компир</p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInDown">
                ...
                <div className="member-info">
                  ...
                  <p className="position">Семенски Компир</p>
                  <p className="position">Средно Ран</p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">Georgina</Link>
                  </h3>
                  <p className="position">Семенски Компир</p>
                  <p className="position">Средно Ран</p>
                </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInDown">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">Red Fantasy</Link>
                  </h3>
                  <p className="position">Семнски Компир</p>
                  <p className="position">Средно Ран</p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">Agria</Link>
                  </h3>
                  <p className="position">Семенски компир</p>
                  <p className="position">Средно Касен</p>
                </div>
              </div>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
            ...
            <div  className="col-xl-3 col-lg-4 col-md-6 col-sm-12">
              <div className="team-member_one text-center mb-60 wow fadeInUp">
                ...
                <div className="member-info">
                  <h3 className="title">
                    <Link href="/farmers">Margarita</Link>
                  </h3>
                  <p className="position">Семенски компир</p>
                  <p className="position">Средно Касен</p>
                </div>
